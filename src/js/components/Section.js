...
Click a video to listen and learn more!`,
  ...
  createArcadeSection() {
    ...
    this._addSubtitle("A glorious cacophony.", -150);
    // this._addEra("1980-1985");
    this._addMultilineText({
      text: `As technological advances were made and costs fell, a new generation
of arcade machines were built with programmable sound generators (PSGs)
...
tones to be manipulated to have different sound characteristics programmatically, 
...
MIDI is simply a set of playback instructions, but when paired with 
...
this._addMultilineText({
      text: `“A Brief History of Video Game Music.” Library of Congress, Washington, D.C. 20540 USA, 
https://www.loc.gov/item/webcast-9342/. Accessed 17 Aug. 2021.

Collins, Karen. Beep: A Documentary History of Game Sound. Ehtonal, 2016.

Collins, Karen. Game sound: an introduction to the history, 
theory, and practice of video game music and sound design. Mit Press, 2008.

Cunningham, Stuart, Vic Grout, and Richard Hebblewhite. 
"Computer game audio: the unappreciated scholar of the half-life generation." Audio-Mostly 2006 (2006).
`,
      font: "Schnyder L",
      size: 24,
      x: 0,
